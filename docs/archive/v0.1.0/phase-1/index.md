...
| :--- | :--- | :--- | :--- | :--- |
| **Sprint 1.1** | Week 1 | 核心狀態機 | `AgentState`, `Graph`, `ContextManager` | [PHASE1_SKILLS.md §Sprint 1.1](./PHASE1_SKILLS.md#sprint-11-核心狀態機-week-1) |
...
# 4. 提交
git add .
git commit -m "feat(core): add AgentState immutable container"
```
